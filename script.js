...
let bjpCount = parseInt(localStorage.getItem("bjpCount")) || 0;
...
const bjpCountElem = document.getElementById("bjp-count");
...
document.getElementById("bjp-btn").addEventListener("click", function () {
  bjpCount++;
  updateVoteCount();
